...
PORTBLAS_INLINE VectorView<_container_t, _IndexType,
    ...
    : data_(data),
      size_(size),
      strd_(strd),
      ptr_(strd > 0 ? data_ : data_ + (size_ - 1) * (-strd_)) {}
...
template <class _container_t, typename _IndexType, typename layout,
          bool has_inc>
PORTBLAS_INLINE MatrixView<_container_t, _IndexType, layout,
                           has_inc>::MatrixView(_container_t data,
                                                _IndexType sizeR,
                                                _IndexType sizeC)
    : data_(data),
      sizeR_(sizeR),
...
template <class _container_t, typename _IndexType, typename layout,
          bool has_inc>
PORTBLAS_INLINE
MatrixView<_container_t, _IndexType, layout, has_inc>::MatrixView(
...
MatrixView<_container_t, _IndexType, layout, has_inc>::MatrixView(
    _container_t data, _IndexType sizeR, _IndexType sizeC, _IndexType sizeL,
    _IndexType inc)
    : data_{data}, sizeR_(sizeR), sizeC_(sizeC), sizeL_(sizeL), inc_(inc) {
...
template <class _container_t, typename _IndexType, typename layout,
          bool has_inc>
PORTBLAS_INLINE void MatrixView<_container_t, _IndexType, layout,
                                has_inc>::adjust_access_displacement() const {}
